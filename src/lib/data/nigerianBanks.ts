/**
 * Nigerian banks and their NIBSS/NIP bank codes - the short numeric code
 * (e.g. "058" for GTBank, "057" for Zenith) used to identify the destination
 * bank for interbank transfers, distinct from the longer legacy branch
 * clearing "sort code". This is what worker.bankRoutingCode feeds into the
 * disbursement engine's NIBSS bulk-file/transfer routing (see
 * disbursement-engine.service.ts and manual-bank-file/generators/csv.generator.ts
 * on the backend), so it must be this code, not any other numbering scheme.
 *
 * Sourced from Paystack's public bank list endpoint (GET /bank?country=nigeria),
 * which republishes the same national NIBSS code assigned to each institution -
 * every Nigerian payment provider uses the same codes since they all settle
 * through NIBSS. Includes commercial banks, microfinance banks, mortgage
 * banks, and payment service banks (Opay, PalmPay, Kuda, Moniepoint, etc).
 * Re-fetch periodically to pick up newly licensed institutions.
 */
...
export const NIGERIAN_BANKS: NigerianBank[] = [
  ...
  { name: 'Al-Barakah Microfinance Bank', code: '50055' },
  { name: 'ALAT by WEMA', code: '035A' },
  { name: 'Alert MFB', code: '51074' },
  { name: 'Alpha Morgan Bank', code: '108' },
  { name: 'Alternative bank', code: '000304' },
  { name: 'Amju Unique MFB', code: '50926' },
  { name: 'Aramoko MFB', code: '50083' },
  { name: 'ASO Savings and Loans', code: '401' },
  { name: 'Assets Microfinance Bank', code: '50092' },
  ...
  { name: 'AZTEC MICROFINANCE BANK LIMITED', code: '51337' },
  { name: 'Bainescredit MFB', code: '51229' },
  { name: 'Banc Corp Microfinance Bank', code: '50117' },
  { name: 'Bank78 Microfinance Bank', code: '11072' },
  { name: 'BANKIT MFB', code: '50572' },
  { name: 'BANKIT MICROFINANCE BANK LTD', code: '50572' },
  ...
  { name: 'Berachah Microfinance Bank Ltd.', code: '50122' },
  { name: 'Beststar Microfinance Bank', code: '50123' },
  { name: 'BOLD MFB', code: '50725' },
  { name: 'Boost Microfinance Bank', code: '51449' },
  { name: 'Bosak Microfinance Bank', code: '650' },
  { name: 'Bowen Microfinance Bank', code: '50931' },
  { name: 'Branch International Finance Company Limited', code: 'FC40163' },
  { name: 'Brent Mortgage bank', code: '90070' },
  { name: 'BuyPower MFB', code: '50645' },
  { name: 'Carbon', code: '565' },
  { name: 'Cashbridge Microfinance Bank Limited', code: '51353' },
  { name: 'CASHCONNECT MFB', code: '865' },
  { name: 'Cedrus MFB', code: '51437' },
  ...
  { name: 'GTI MFB', code: '50368' },
  { name: 'Guaranty Trust Bank', code: '058' },
  { name: 'Hackman Microfinance Bank', code: '51251' },
  { name: 'Haggai Mortgage Bank', code: '90065' },
  { name: 'Hasal Microfinance Bank', code: '50383' },
  { name: 'Hayat Trust MFB', code: '51364' },
  { name: 'HopePSB', code: '120002' },
  { name: 'IBANK Microfinance Bank', code: '51211' },
  { name: 'IBBU MFB', code: '51279' },
  { name: 'Ibile Microfinance Bank', code: '51244' },
  { name: 'Ibom Mortgage Bank', code: '90012' },
  ...
  { name: 'Kayvee Microfinance Bank', code: '5129' },
  { name: 'Keystone Bank', code: '082' },
  { name: 'Kolomoni MFB', code: '899' },
  ...
  { name: 'NIRSAL MICROFINANCE', code: '51304' },
  { name: 'Nombank MFB', code: '50072' },
  { name: 'NOVA BANK', code: '561' },
  { name: 'Novus MFB', code: '51371' },
  { name: 'NPF MICROFINANCE BANK', code: '50629' },
  { name: 'NSUK MICROFINANACE BANK', code: '51261' },
  { name: 'NUVION MFB', code: '51392' },
  { name: 'Olabisi Onabanjo University Microfinance Bank', code: '50689' },
  { name: 'OLUCHUKWU MICROFINANCE BANK LTD', code: '50697' },
  { name: 'OPay Digital Services Limited (OPay)', code: '999992' },
  { name: 'Optimus Bank Limited', code: '107' },
  { name: 'Pact Microfinance Bank', code: '51477' },
  { name: 'Paga', code: '100002' },
  { name: 'PalmPay', code: '999991' },
  { name: 'Parallex Bank', code: '104' },
  { name: 'Parkway - ReadyCash', code: '311' },
  { name: 'PATHFINDER MICROFINANCE BANK LIMITED', code: '090680' },
  { name: 'Paystack MFB', code: '51457' },
  ...
  { name: 'Pettysave MFB', code: 'MFB51452' },
  ...
  { name: 'Prospa Capital Microfinance Bank', code: '50739' },
  ...
  { name: 'SPECTRUM MFB LTD', code: '50756' },
  { name: 'Springfield Microfinance Bank', code: '51429' },
  ...
  { name: 'Summit Bank', code: '00305' },
  { name: 'Suntrust Bank', code: '100' },
  { name: 'Supreme MFB', code: '50968' },
  { name: 'TAJ Bank', code: '302' },
  { name: 'Tangerine Money', code: '51269' },
  { name: 'Tatum Bank', code: '109' },
  { name: 'TENN', code: '51403' },
  { name: 'Think Finance Microfinance Bank', code: '677' },
  { name: 'Titan Bank', code: '102' },
  { name: 'TransPay MFB', code: '090708' },
  { name: 'TRUSTBANC J6 MICROFINANCE BANK', code: '51118' },
  { name: 'U and C MFB', code: '50840' },
  { name: 'UBJ Microfinance Bank Limited', code: '51396' },
  { name: 'UCEE MFB', code: '090706' },
  { name: 'Uhuru MFB', code: '51322' },
  { name: 'Ultraviolet Microfinance Bank', code: '51080' },
  { name: 'Unaab Microfinance Bank Limited', code: '50870' },
  { name: 'UNIABUJA MFB', code: '51447' },
  { name: 'Unical MFB', code: '50871' },
  { name: 'Unilag Microfinance Bank', code: '51316' },
  { name: 'UNIMAID MICROFINANCE BANK', code: '50875' },
  { name: 'Union Bank of Nigeria', code: '032' },
  { name: 'United Bank For Africa', code: '033' },
  { name: 'Unity Bank', code: '215' },
  { name: 'UNIUYO Microfinance Bank Ltd', code: '50880' },
  ...
  { name: 'Victory MFB', code: '51085' },
  { name: 'Waya Microfinance Bank', code: '51355' },
  { name: 'Wema Bank', code: '035' },
  { name: 'Weston Charis MFB', code: '51386' },
  { name: 'Whitecrust Finance Company', code: '402001' },
  { name: 'Xpress Wallet', code: '100040' },
  { name: 'YCT MFB', code: '51253' },
  { name: 'Yes MFB', code: '594' },
  { name: 'Zenith Bank', code: '057' },
  { name: 'Zitra MFB', code: '51373' },
];
